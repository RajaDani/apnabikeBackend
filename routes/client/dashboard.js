...
router.get('/getLatestTransactions', Authorize.verifyUserToken, dashboard.getUserLatestTransactions);
router.get('/getbookings', Authorize.verifyUserToken, dashboard.getUserLatestTransactions);
